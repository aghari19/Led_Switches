...
// TODO: Define the Ports for the P2 LEDs and the Booster XL LEDs
// Define the LEDs for P2
#define RIGHT_RED BIT0;     // P2.0
#define RIGHT_GREEN BIT1;   // P2.1
#define RIGHT_BLUE BIT2;    // P2.2

// Define the BoosterXL LEDS ports
...
// This function is used to make your LED colors
void BoosterLEDColors(drawn_color *pick);

// This function is used to display what the correct color displayed on the BoosterXL LED should be
...
void LED2Colors(color_selected picked) {
	...
	// TODO: enable the LED 2 Blue light
	P2OUT = P2OUT | RIGHT_BLUE;
	P2OUT = P2OUT & ~RIGHT_RED;
	P2OUT = P2OUT & ~RIGHT_GREEN;
